...
public class SignUp_Nakes_UI extends javax.swing.JFrame {
    ...
    TenagaKesehatan nakesSignUp = new TenagaKesehatan();
    ...
    private void DaftarButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DaftarButton2ActionPerformed
        // TODO add your handling code here:
        try{
            nakesSignUp.signUp(UsernameTextField4.getText().trim(), PasswordTextField4.getText().trim(), EmailTextField1.getText().trim());
        }catch(Exception e){
