 ...
 * @author LENOVO
 */
public class editJadwal2 extends javax.swing.JFrame {

    /**
     * Creates new form tambahJadwal
     */
    private int id;
    public editJadwal2(Jadwal jadwal) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editJadwal2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editJadwal2(n).setVisible(true);
            }
        });
    }
